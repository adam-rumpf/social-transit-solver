...
typedef priority_queue<tuple<double, pair<int, int>, bool>, vector<tuple<double, pair<int, int>, bool>>, greater<tuple<double, pair<int, int>, bool>>> move_queue; // min-priority queue for storing objective/move/new tuples in the neighborhood search
